...
public class RoleController {
    ...
    public ModelAndView list(
        ...
        List<RolePermissionAllocationBo> roleList = roleService.findRoleAndPermission(roleName); //查询符合条件的所有Role角色
...
//            roleMenu.setRoleId(roleId);
    ...
    public void updateMenu(@RequestParam(value = "roleId") String roleId,Role role,HttpServletRequest request,HttpServletResponse response) {
        ...
        roleService.update(role);
    		...
    		List<Long> userIds = userService.findUserIdByRoleId(roleId);
