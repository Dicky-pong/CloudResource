...
<html lang="en">
  ...
  <body>
           ...
           <table cellpadding="2">
		            ...
		            <label class="checkbox">
	             	  <span class="pull-left">
	             	  	<li>
	             	  	 <input type="checkbox" checked="checked" name="rememberMe" id="rememberMe">记住我
	             	  	</li>
	             	  </span>
		            ...
		            <button class="btn btn-theme btn-block login-btn" type="submit"><i class="fa fa-lock"></i> 登录</button>
		            <hr>
    ...
    <script>
	  ...
	  <script type="text/javascript">
	  $('.login-btn').click(function checkForm(e){
