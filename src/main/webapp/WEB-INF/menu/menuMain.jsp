    ...
    <section id="main-content">
        ...
        <section class="wrapper site-min-height">
            ...
            <div class="row mt">
                <div class="col-lg-12">
		                    <div class="col-lg-4">
		                        <button type="button" class="btn btn-theme02" onclick="openAddRole('menu/preinsert.htm')"><i class="glyphicon glyphicon-plus"></i>新增</button>
		                    </div>
                        <div class="pull-right">
                            <form class="form-inline" role="form" action="menu/list.htm" method="post">

                                <div class="form-group">
                                    <label class="control-label" for="roleNameId">菜单名：</label>
                                    <input type="text" name="menuName" class="form-control" id="menuNameId" placeholder="">
                                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach var="menu" items="${menuList}" varStatus="status">
                            <tr>
                                ...
                                <td><center>${menu.menuName } </center></td>
                                <td><center>${menu.url} </center></td>
								<td><center>${menu.pid} </center></td>
                                <td width="180px">
                                    <center>
...
<!-- 让侧边栏菜单高亮 -->
<script>$("#menuMainId").attr({"class" : "active"});</script>
<!--引入此页面的js-->
